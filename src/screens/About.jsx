      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mt-4">
            We are passionate about creating unforgettable experiences and delivering excellence in every event we plan.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              As professionals, we save you time, energy, and ensure you stay within budget and meets business objectives.
            </p>
            
            <div className="flex items-start space-x-4 mb-6">
              <div className="bg-primary-blue rounded-full p-2 mt-1">
                <Icon icon="mdi:clock-time-four" className="text-white text-xl" />
              </div>
              <div>
                <h4 className="font-bold text-gray-800 mb-1">Time Efficiency</h4>
                <p className="text-gray-600">We handle all the details so you can focus on enjoying your event.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 mb-6">
              ...
              <div>
                <h4 className="font-bold text-gray-800 mb-1">Budget Management</h4>
                <p className="text-gray-600">We work within your budget to deliver maximum value.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-gray-800 mb-1">Goal-Oriented</h4>
                <p className="text-gray-600">We ensure your event meets all business and personal objectives.</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Founded in 2017, we are an entertainment conglomerate that deals on every aspect of entertainment. We have proficient teams devoted to providing innovation and solving entertainment issues of our clients.
            </p>
            
            <p className="text-gray-700 mb-6 leading-relaxed">
              If you're looking to plan and package your event or to brand and popularize your business, then we're your plug. With a team that's well qualified, our primary concern is giving your brand the befitting identity.
            </p>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="bg-primary-blue bg-opacity-10 p-3 rounded-full">
                  <Icon 
                    icon={
                      index === 0 ? "mdi:check-decagram" : 
                      index === 1 ? "mdi:clipboard-check" : 
                      index === 2 ? "mdi:shield-check" : 
                      index === 3 ? "mdi:lightning-bolt" : 
                      index === 4 ? "mdi:trophy" : "mdi:rocket-launch"
                    } 
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-primary-blue text-sm font-medium mb-4">{member.position}</p>
        ...
        <div className="mt-16 text-center">
          ...
          >
            Get in Touch
            <Icon icon="material-symbols:arrow-forward-rounded" className="ml-2" />
          </a>
        </div>
      </div>
    </section>
